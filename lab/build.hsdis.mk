...
lib_suffix=$(if is_mac,dylib,so)
GDB_FOLDER=$(HOME)/Documents/sourceware
gdb_path=$(GDB_FOLDER)/binutils-gdb
src_hsdis_lib=$(jdk.dir)/src/utils/hsdis/build/$(os_name)-amd64/hsdis-amd64.$(lib_suffix)
dst_hsdis_lib=$(jdk.dir)/build/$(os_name)-x86_64-$(java_variant)-slowdebug/jdk/lib/server/hsdis-amd64.$(lib_suffix)
$(gdb_path):
	mkdir -p $(GDB_FOLDER)   \
	&& cd $(GDB_FOLDER) 		\
...
$(src_hsdis_lib): $(gdb_path)
	...
	cd $(jdk.dir)/src/utils/hsdis && make all64 BINUTILS=$(gdb_path)
